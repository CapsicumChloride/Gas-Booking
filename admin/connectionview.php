...
<html lang="en">
  <head>
    ...
    <title>Connection Applications</title>
...
<tr>
<th>Id</th><td><?=$r['id']?></td>
<th>Name</th><td><?=$r['name']?></td>
</tr>
<tr>
<th>Username</th><td><?=$r['username']?></td>
<th>Consumer No.</th><td><?=$r['consumer']?></td>
</tr>
<tr>
<th>Mobile No.</th><td><?=$r['mob']?></td>
<th>Address</th><td><?=$r['adress']?></td>
</tr>
<tr>

<th>Status</th><td><?=$r['status']?></td>
<th>Date Applied</th><td><?=$r['date']?></td>
</tr>
<tr>
<td colspan="4"><embed src="../upload/<?=$r['proof']?>" type="" style="height:500px;width:100%"></td></tr>
</table>
<?php
}
?>
