...
<html lang="en">
  <head>
    ...
    <title>Kapsona's LPG Bookings</title>
    ...
    <div class="flex-box-admin";>
      <!-- Only for Wide Screens -->
        <div class="admin-leftpane">
                ...
                <li class="nav-item">
                <a class="nav-link active" href="booking.php">Gas Bookings</a>
                </li>
                <li class="nav-item">
      ...
      <div class="admin-topnav" style="display:none";>
          ...
          <a href="booking.php">
            <button class="admin-but superactive">Gas <br>Bookings</button>
          </a>
          <a href="reports.php">
            ...
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                ...
                ?>
                  ...
                  <div class="galley-chamber">                    
                    <h3> BULK ISSUE TO SECTION ONE</h3> 
                    <table class="table table-bordered">
                      ...
                      <br>
                      <div class="form-group text-center chamber-button"><button type="post" class="btn btn-primary" name="submitbulkissueone">Issue Gas</button></div>
                      </form>
                    </table>
                  </div>
                  ...
                  <div class="wardroom-chamber">                    
                    <h3> BULK ISSUE TO SECTION TWO</h3> 
                    <table class="table table-bordered">
                      ...
                      <div class="form-group chamber-item"><label for="quantity">Qty Issued</label><input type="text" name="quantity" id="quantity" class="form-control"></div>
                      <br>
                      <div class="form-group text-center chamber-button"><button type="submit" class="btn btn-primary" name="submitbulkissuetwo">Issue Gas</button></div>
                      </form>
                    </table>
                  </div>
                  <!--End Ward Room Issue-->
...
if(isset($_POST['submitbulkissueone']))
{
  extract($_POST);
...
if(isset($_POST['submitbulkissuetwo']))
{
  extract($_POST);
