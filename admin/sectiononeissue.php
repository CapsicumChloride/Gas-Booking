...
<head>
    ...
    <title>Bulk Issue One: Kapsona's Gas</title>
            ...
            <div class="col-md-12">
                <div class="card mt-5">
                    <div class="card-header">
                        <center><h4>GAS ISSUED TO SECTION ONE BETWEEN DATES</h4></center>
                    </div>
                    <div class="card-body">
                ...
                <div class="card mt-4">
                    <div class="card-body">
                        <table class="table table-borderd">
                            ...
                            <?php 
                                ...
                                if(isset($_GET['from_date']) && isset($_GET['to_date']))
                                {
                                    ...
                                    $query = "SELECT * FROM sectionone WHERE issuedate BETWEEN '$from_date' AND '$to_date' ";
                            ...
                            $sql_qry = "SELECT SUM(quantity) AS count FROM sectionone WHERE issuedate BETWEEN '$from_date' AND '$to_date'";
                        ...
                        <a href="sectiononeissue_excel.php?from_date='$from_date'&to_date='$to_date'"><input type="submit" name="excel" value="Download Excel"></a>
                    </div>
