...
<html lang="en">
  <head>
    ...
    <title>Kapsona Gas - <?php echo ($_SESSION['name']) ?> </title>
    <style>
    .container-fluid {
...
<tr><th>Username</th><td><?php echo $r['username']?></td></tr>
<tr><th>Mobile</th><td><?php echo $r['mob']?></td></tr>
<tr><th>Consumer ID</th><td><?php echo $r['consumer']?></td></tr>
<tr><th>Address</th><td><?php echo $r['adress']?></td></tr>
<tr><th>Member Since</th><td><?php echo $r['date']?></td></tr>
<tr> <td colspan="2" class="text-right">
<button type="button" class="btn btn-primary" id="cust-left-button" data-toggle="modal" data-target="#edit">
  Edit Profile
</button>
<button type="button" class="btn btn-dark" id="cust-left-button" data-toggle="modal" data-target="#changepswd">
  Change Password
</button>
<button type="button" class="btn btn-info " id="cust-left-button" data-toggle="modal" data-target="#feedback">
  Admin Message
</button>
</td></tr>
</table>
...
<div class="jumbotron jumbotron-fluid">
  <div class="container">
    ...
    if($status=="approved")
    {
      echo "<span class='text-success'>Your Application is Valid And Approved. You May Procced For Booking</span>";
    }
    ...
    {
      echo "<span class='text-danger'>Waiting for Approval from Admin</span>";
    }
    ?>
    </p>
  </div>
...
<div class="form-group"><label for="name">Username</label><input type="text" name="username" id="username" value='<?php echo $r['username']?>' class="form-control"></div>
...
<div class="form-group"><label for="mob">Consumer ID</label><input type="text" name="consumer" id="consumer" value='<?php echo $r['consumer']?>' class="form-control"></div>
...
<div class="modal fade" id="feedback" >
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="edit">Admin Message</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
